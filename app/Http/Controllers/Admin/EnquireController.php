...
class EnquireController extends Controller
{
    ...
    {
        $this->middleware('permission:view enquire_form')->only('index');
        $this->middleware('permission:create enquire_form')->only(['create', 'store']);
        $this->middleware('permission:edit enquire_form')->only(['edit', 'update']);
        $this->middleware('permission:delete enquire_form')->only('destroy');
    }
    /**
