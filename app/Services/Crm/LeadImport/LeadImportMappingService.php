...
class LeadImportMappingService
{
    ...
    {
        return [
            'full_name' => ['full_name', 'name', 'lead_name', 'parent_name', 'parent_lead_name', 'parent_lead_name', 'contact_name', 'customer_name'],
            'first_name' => ['first_name', 'firstname', 'given_name', 'fname'],
            'last_name' => ['last_name', 'lastname', 'surname', 'lname', 'family_name'],
            'phone' => ['phone', 'phone_number', 'mobile', 'mobile_number', 'telephone', 'contact_number', 'whatsapp', 'whatsapp_number', 'tel'],
            ...
            'advertising_platform' => ['platform', 'channel', 'ad_platform'],
            ...
            'assigned_to_name' => ['agent', 'agent_name', 'owner', 'assigned_to', 'assignee'],
