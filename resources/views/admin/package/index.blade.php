...
<div class="col-12">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h6 class="card-title text-primary mb-0">Package Lists</h6>
        @can('create package')
        <a href="{{ route('admin.package.create') }}" class="btn btn-primary btn-sm">+ Add</a>
        @endcan
    </div>
          <div class="card-body">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @endcan
                            @can('delete group')
                            <form id="delete-form-{{ $item->id }}" action="{{ route('admin.package.destroy', $item->id) }}" method="POST" style="display: none;">
                                @csrf @method('DELETE')
                            </form>
