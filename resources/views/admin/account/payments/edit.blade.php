...
<div class="acct-settings-workspace">
    <div class="acct-settings-card">
        <form method="POST" action="{{ route('admin.account.payments.update') }}" class="em-settings-form">
            ...
            <div class="acct-settings-card__head">
                <div>
                    <h2 class="acct-settings-card__title">Stripe &amp; checkout</h2>
                    <p class="acct-settings-card__sub">These keys are for your school’s customer payments — separate from your Enrolliq subscription billing.</p>
                </div>
            </div>

            <div class="acct-settings-card__body">
                <div class="acct-settings-stack">
                    <section class="em-form-block">
                        <div class="em-form-block__head">
                            ...
                            <div>
                                ...
                                <p class="em-form-block__desc">Connect your Stripe account to accept card payments from parents and applicants.</p>
                            </div>
                        </div>
