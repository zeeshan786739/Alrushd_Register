    ...
    <div class="col-lg-10 m-auto">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                @can('view languages')
                <a href="{{ route('admin.subjects.index') }}" class="btn btn-primary btn-sm">← Back</a>
                @endcan
            </div>
            <div class="card-body">
                <form class="row gy-3 needs-validation" novalidate action="{{ route('admin.subjects.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
