...
<div class="dashboard-main-body crm-list-view" id="crm-leads-page">
    ...
    <div class="row g-3 mb-24">
        ...
        <div class="col-sm-6 col-xl-3">@include('admin.partials.dashboard-stat-card', ['label'=>'Facebook (7d)','value'=>$stats['facebook_this_week'],'icon'=>'logos:facebook','tone'=>'gold'])</div>
        ...
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table table-hover mb-0">
                    <thead><tr><th>Name</th><th>Source</th><th>Status</th><th>Priority</th><th>Assigned</th><th>Follow-up</th><th>Created</th><th></th></tr></thead>
                    <tbody>
        ...
        @foreach($leads as $lead)
            <div class="crm-record-card">
                ...
                <div class="text-sm text-secondary-light mb-12">
                    ...
                    · Priority: {{ ucfirst($lead->priority) }} · {{ $lead->assignedAdmin?->name ?? 'Unassigned' }}
                </div>
    ...
    <form method="POST" action="{{ route('admin.crm.leads.filters.save') }}" class="card radius-12 border-0 shadow-2 mb-24" id="crm-save-filter-form">
        ...
        <div class="card-body p-20 d-flex flex-wrap gap-12 align-items-end">
            ...
            @foreach(request()->only(['search','source','lead_status','priority','assigned_to','sort_by','sort_order']) as $key=>$value)
