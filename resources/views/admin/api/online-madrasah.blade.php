...
@section('title') Online Madrasah Form @endsection
        ...
        <div class="col-md-12">
            <div class="card card-cyan">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="card-title text-primary mb-0">Online Madrasah Form</h5>
                </div>
                <div class="card-body">
                            ...
                            @foreach($paginatedData as $entry)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('admin.online-madrasah.view', $entry['entry_id']) }}" class="btn btn-sm btn-primary">View</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
        ...
        filtered.forEach(entry => {
            ...
            tbody.innerHTML += `
                <tr>
                    ...
                    <td>${entry.meta['name-4'] ?? ''}</td>
                    <td class="text-center">
                        <a href="/admin/online-madrasah/view/${entry.entry_id}" class="btn btn-sm btn-primary">View</a>
                    </td>
                </tr>
            `;
        });
