                            ...
                            @foreach($paginatedData as $entry)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('admin.enquire-now.view', $entry['entry_id']) }}" class="btn btn-sm btn-primary">View</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
        ...
        filtered.forEach(entry => {
            ...
            tbody.innerHTML += `
                <tr>
                    ...
                    <td>${entry.meta['name-4'] ?? ''}</td>
                    <td class="text-center">
                        <a href="/admin/enquire-now/view/${entry.entry_id}" class="btn btn-sm btn-primary">View</a>
                    </td>
                </tr>
            `;
        });
