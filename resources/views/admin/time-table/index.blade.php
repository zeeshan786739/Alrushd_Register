...
@section('title') Time Table @endsection

@section('content')

<div class="card basic-data-table">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h6 class="card-title text-primary mb-0">Time Tables</h6>
        @can('create group')
        <a href="{{ route('admin.time-tables.create') }}" class="btn btn-primary btn-sm">+ Add</a>
        @endcan
    </div>
        ...
        <table class="table bordered-table mb-0" id="dataTable" data-page-length='10'>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        @can('view group')
                        <a href="{{ route('admin.time-tables.edit', $item->id) }}"
                        ...
                        @endcan
                        @can('delete group')
                        <form id="delete-form-{{ $item->id }}" action="{{ route('admin.time-tables.destroy', $item->id) }}" method="POST" style="display: none;">
                            @csrf @method('DELETE')
                        </form>
