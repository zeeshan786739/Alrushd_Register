...
@section('title') Relation Ships @endsection
...
<div class="col-12">
    <div class="card basic-data-table">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h6 class="card-title text-primary mb-0">Relation Ships Lists</h6>
             <a href="{{ route('admin.relation-ships.create') }}" class="btn btn-primary btn-sm">+ Add</a>
        </div>
        <div class="card-body">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('admin.relation-ships.edit', $item->id) }}"
                                ...
                                <form id="delete-form-{{ $item->id }}" action="{{ route('admin.relation-ships.destroy', $item->id) }}" method="POST" style="display: none;">
                                    @csrf @method('DELETE')
                                </form>
