...
<div class="col-12">
    <div class="card basic-data-table">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h6 class="card-title text-primary mb-0">Country Lists</h6>
             <a href="{{ route('admin.countries.create') }}" class="btn btn-primary btn-sm">+ Add</a>
        </div>
        <div class="card-body">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form id="delete-form-{{ $item->id }}" action="{{ route('admin.countries.destroy', $item->id) }}" method="POST" style="display: none;">
                                    @csrf @method('DELETE')
                                </form>
