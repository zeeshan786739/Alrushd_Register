...
@section('title') AdmissionDate @endsection
...
<div class="col-12">
    <div class="card basic-data-table">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h6 class="card-title text-primary mb-0">AdmissionDate Lists</h6>
             <a href="{{ route('admin.admission-date.create') }}" class="btn btn-primary btn-sm">+ Add</a>
        </div>
        <div class="card-body">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('admin.admission-date.edit', $item->id) }}"
                                ...
                                <form id="delete-form-{{ $item->id }}" action="{{ route('admin.admission-date.destroy', $item->id) }}" method="POST" style="display: none;">
                                    @csrf @method('DELETE')
                                </form>
