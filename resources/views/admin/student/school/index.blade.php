...
<div class="col-12">
    <div class="card basic-data-table">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h6 class="card-title text-primary mb-0"> School List</h6>

            <a href="{{ route('admin.student-school.create') }}" class="btn btn-primary btn-sm">+ Add</a>
            ...
            <table class="table bordered-table mb-0" id="dataTable" data-page-length='10'>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($item->image)
                            <img src="{{ Storage::url($item->image) }}" alt="Image" width="80">
                            @else
                        ...
                        <td>
                            ...
                            <a href="{{ route('admin.student-school.edit', $item->id) }}"
                            ...
                            <form id="delete-form-{{ $item->id }}" action="{{ route('admin.student-school.destroy', $item->id) }}" method="POST" style="display: none;">
                                @csrf @method('DELETE')
                            </form>
