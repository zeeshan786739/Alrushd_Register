...
@section('title') Student Course @endsection

@section('content')
<div class="col-12">
    <div class="card basic-data-table">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h6 class="card-title text-primary mb-0"> Student Course</h6>

            <a href="{{ route('admin.student-course.create') }}" class="btn btn-primary btn-sm">+ Add</a>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route('admin.student-course.edit', $item->id) }}"
                            ...
                            <form id="delete-form-{{ $item->id }}" action="{{ route('admin.student-course.destroy', $item->id) }}" method="POST" style="display: none;">
                                @csrf @method('DELETE')
                            </form>
