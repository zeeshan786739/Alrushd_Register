...
@section('title') Update Group @endsection
...
<div class="row gy-4 pt-5">
    <div class="col-lg-10 m-auto">
        <div class="card">
            ...
            <div class="card-body">
                <form class="row gy-3 needs-validation" novalidate action="{{ route('admin.student-groups.update',$data->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
