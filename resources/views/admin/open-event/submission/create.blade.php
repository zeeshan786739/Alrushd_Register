...
@section('title') Add Open Event Submission From @endsection
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="card-title text-primary mb-0"><span class="icon">
                    ...
                    </span>Add Open Event Submission From</h5>


                <a href="{{ route('admin.open-event-form.index') }}" class="btn btn-primary btn-sm">← Back</a>

            </div>
            <div class="card-body">
                <form class="row gy-3 needs-validation" novalidate action="{{ route('admin.open-event-form.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="col-md-12">
                        ...
                        <div class="has-validation">
                            <input type="text" name="sfname" id="sfname" class="form-control @error('sfname') is-invalid @enderror" value="{{ old('sfname') }}">
                            @error('sfname')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="has-validation">
                            <input type="text" name="slname" id="slname" class="form-control @error('slname') is-invalid @enderror" value="{{ old('slname') }}">
                            @error('slname')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
