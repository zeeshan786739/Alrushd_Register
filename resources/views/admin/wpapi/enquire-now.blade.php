...
@include('admin.partials.wpapi-filter-bar', [
    'action' => route('admin.enquire-now'),
...
<div class="col-12">
    <div class="card basic-data-table">
        <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-10">
            <h6 class="card-title text-primary mb-0">Enquire Now List</h6>
            <form action="{{ route('admin.form.import.contact', '14881') }}" method="GET" class="d-inline mb-0">
                    ...
                    <tr>
                        ...
                        <td>
                            @include('admin.partials.table-actions', [
                                'viewUrl' => route('admin.enquire-now-view', $entry->entry_id),
                                'canEdit' => false,
                                'canDelete' => false,
                            ])
                        </td>
