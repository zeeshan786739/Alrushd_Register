...
@section('title') Referral Now Details @endsection
...
<div class="col-12">
    <div class="card basic-data-table">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h6 class="card-title text-primary mb-0">Referral Now Details</h6>
            <a href="{{ route('admin.referral-applications') }}" class="btn btn-primary btn-sm">← Back</a>
        </div>
        <div class="card-body">
            <div class="row">
                <table class="table table-border">
                    ...
                    <tr>
                        ...
                        @php
                            ...
                            $formattedDate = $dateData ? date('d-m-Y', strtotime($dateData->year . '-' . $dateData->month . '-' . $dateData->day)) : '';
                        @endphp
