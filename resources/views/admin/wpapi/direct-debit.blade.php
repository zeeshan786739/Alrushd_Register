...
<!-- 🔍 Filter Form -->
<form method="GET" action="{{ route('admin.direct-debit') }}"
    ...
    <div class="col-lg-2 mt-24">
        ...
        <a href="{{ route('admin.direct-debit') }}" class="btn btn-dark">Reset</a>
    </div>
        ...
        <div class="col-md-12">
            <div class="card card-cyan">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="card-title text-primary mb-0">Direct Debit Form</h5>
                    <div class="text-end">
                        <form action="{{ route('admin.form.import.contact',14433) }}" method="GET">
                    ...
                    <div class="table-responsive" style="overflow-x: auto; width: 100%;">
                        ...
                        <tbody id="tableBody">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('admin.debit-now-view', $entry->entry_id) }}"
