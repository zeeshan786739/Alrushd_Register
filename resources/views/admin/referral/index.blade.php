...
<form method="GET" action="{{ route('admin.referrals.index') }}"
    ...
    <div class="col-lg-2 mt-24">
        ...
        <a href="{{ route('admin.referrals.index') }}" class="btn btn-dark">Reset</a>
    </div>
        ...
        <div class="col-md-12">
            <div class="card card-cyan">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="card-title text-primary mb-0">Refferal Now Form</h5>
                    <!-- ✅ Pagination Section -->
                        ...
                        <tbody id="tableBody">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('admin.referrals.show', $entry->id) }}"
                                    ...
                                    <form id="delete-form-{{ $entry->id }}"
                                        action="{{ route('admin.referrals.destroy', $entry->id) }}" method="POST"
                                        style="display: none;">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                    ...
                    {{-- <div class="mt-3 d-flex justify-content-end">
                        <ul class="pagination">
                            ...
                            @for ($i = 1; $i <= $paginatedData->lastPage(); $i++)
                                ...
                                <li
                                    class="page-item {{ $paginatedData->currentPage() == $paginatedData->lastPage() ? 'disabled' : '' }}">
