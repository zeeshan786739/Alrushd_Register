...
@section('title') Referral Form Details (Entry #{{ $data->entry_id }}) @endsection
...
<div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
    <h6 class="fw-semibold mb-0">Referral Form Details (Entry #{{ $data->entry_id }})</h6>
    <ul class="d-flex align-items-center gap-2">
        <li class="fw-medium"><a href="{{ route('admin.referrals.index') }}" class="btn btn-dark btn-sm">Back</a></li>
    </ul>
</div>
