...
<!-- 🔍 Filter Form -->
<form method="GET" action="{{ route('admin.staff-applications-form.index') }}"
    ...
    <div class="col-lg-4">
        ...
        <input type="text" name="search" class="form-control search"
            placeholder="Search Job Applied For, Surname or country..." value="{{ request('search') }}">
    </div>
    <div class="col-lg-3">
    ...
    <div class="col-lg-2 mt-24">
        ...
        <a href="{{ route('admin.staff-applications-form.index') }}" class="btn btn-dark">Reset</a>
    </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route('admin.staff-applications-form.show', $item->id) }}"
                                class="w-32-px h-32-px bg-primary-light text-primary-600 rounded-circle d-inline-flex align-items-center justify-content-center">
                                <iconify-icon icon="iconamoon:eye-light"></iconify-icon>
                            </a>

                            <form id="delete-form-{{ $item->id }}"
                                action="{{ route('admin.staff-applications-form.destroy', $item->id) }}" method="POST"
                                style="display: none;">
                                @csrf @method('DELETE')
                            </form>
