...
<div class="em-settings-workspace">
    ...
    <div class="em-settings-card">
        <form method="POST" action="{{ route('admin.email.mailbox.settings.update') }}" class="em-settings-form">
            ...
            <div class="em-settings-card__head">
                <div>
                    <h2 class="em-settings-card__title">Delivery &amp; tracking</h2>
                    <p class="em-settings-card__sub">Global controls for this workspace. Sender identities are managed above.</p>
                </div>
            </div>
            ...
            <div class="em-settings-card__body">
                <div class="em-settings-stack">
                    <section class="em-form-block">
                        <div class="em-form-block__head" style="padding:14px 16px;border-bottom:1px solid var(--crm-border);">
                            ...
                            <div>
                                ...
                                <p class="em-form-block__desc">Turn on outbound email and inbox features for this school.</p>
                            </div>
                        </div>
