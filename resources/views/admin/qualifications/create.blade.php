...
@section('title') Add Qualification @endsection
    ...
    <div class="col-lg-12 m-auto">
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-body">
                    <form class="row gy-3 needs-validation" novalidate action="{{ route('admin.qualifications.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="has-validation">
                                <select name="qualification_package_id" id="qualification_package_id" class="form-control form-select @error('qualification_package_id') is-invalid @enderror">
                                    <option value="1">Core Package</option>
                                    <option value="2">3 Subjects Package</option>
                                </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="has-validation">
                                <input type="text" name="subject_selector" id="subject_selector" class="form-control @error('subject_selector') is-invalid @enderror" value="{{ old('subject_selector') }}">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="has-validation">
                                <textarea id="description" name="description" class="summernote form-control @error('description') is-invalid @enderror"></textarea>
                                @error('description')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="has-validation">
                                <input type="number" name="total_subjects" id="total_subjects" class="form-control @error('total_subjects') is-invalid @enderror" value="{{ old('total_subjects') }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="has-validation">
                                <input type="text" name="hifdh_programme" id="hifdh_programme" class="form-control @error('hifdh_programme') is-invalid @enderror" placeholder="Hifdh Programme" value="{{ old('hifdh_programme') }}">
                        ...
                        <div class="col-lg-3">
                            <input class="form-check-input" type="checkbox" value="{{ $item->id }}" id="core_subject-{{$item->id}}" name="core_subjects[]">
                        ...
                        @foreach($subjects as $item)
                        <div class="col-lg-3">
                            <input class="form-check-input" type="checkbox" value="{{ $item->id }}" id="additional_subject-{{$item->id}}" name="additional_subjects[]">
                        ...
                        {{-- Free Islamic & Quranic Subject --}}
                        @foreach($subjects as $item)
                        <div class="col-lg-3">
                            <input class="form-check-input" type="checkbox" value="{{ $item->id }}" id="additional_islamic_subject-{{$item->id}}" name="additional_islamic_subjects[]">
                        ...
                        <div class="col-lg-3">
                            <input class="form-check-input" type="checkbox" value="{{ $item->id }}" id="additional_language-{{$item->id}}" name="additional_languages[]">
