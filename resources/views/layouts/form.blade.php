<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="ar-form-html">
<head>
    <meta charset="utf-8">
    ...
    <link href="{{ asset('frontend/assets/css/alrushd-form-theme.css') }}" rel="stylesheet">
    @yield('css')
</head>
<body class="ar-form-body">
    @yield('content')
