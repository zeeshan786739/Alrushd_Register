...
@section('title','Al-rushd Online School - Enquire Now')
@section('css')
<link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css" rel="stylesheet" />
<link href="{{ asset('frontend/assets/css/jquery-countryselector.min.css') }}" rel="stylesheet" />
@endsection
@section('content')
 <a href="{{ route('enquire-now') }}" class="logo d-flex align-items-center m-auto" style="background: #f6f9fc;padding-top:10px;padding-bottom:10px;">
        ...
        <div class="row">
            <div class="col-lg-8 col-12 m-auto">
                ...
                <ul class="nav nav-pills justify-content-center gap-3" id="customTab" role="tablist">
                    ...
                    <!-- Enquire Now -->
                    <li class="nav-item">
                        <a class="nav-link active custom-btn" href="{{ route('enquire-now') }}">
                            Enquire Now
                        </a>
                    </li>
